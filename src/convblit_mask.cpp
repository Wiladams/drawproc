...
static inline void ALWAYS_INLINE funcname(PSD psd, PDPBLITPARMS gc,\
...
/* 32bpp BGRA*/
void convblit_copy_mask_mono_byte_lsb_bgra(PSD psd, PDPBLITPARMS gc)
{
...
/* 32bpp BGRA*/
void convblit_copy_mask_mono_word_msb_bgra(PSD psd, PDPBLITPARMS gc)
{
...
/* 32bpp BGRA*/
void convblit_copy_mask_mono_byte_msb_bgra(PSD psd, PDPBLITPARMS gc)
{
...
*/
static inline void ALWAYS_INLINE convblit_blend_mask_alpha_byte(PSD psd, PDPBLITPARMS gc,
	int DSZ, int DR, int DG, int DB, int DA, int PORTRAIT)
{
	unsigned char *src, *dst;
	int dsz, dst_pitch;
...
/* 32bpp BGRA*/
void convblit_blend_mask_alpha_byte_bgra(PSD psd, PDPBLITPARMS gc)
{
