...
*/
static inline void ALWAYS_INLINE convblit_8888(PSD psd, PDPBLITPARMS gc, int mode,
...
void convblit_srcover_rgba8888_rgba8888(PSD psd, PDPBLITPARMS gc)
{
	convblit_8888(psd, gc, SRCOVER, 4, R, G, B, A, 4, R, G, B, A, psd->portrait);
}

/* Conversion blit copy 32bpp RGBA image to 32bpp RGBA image*/
void convblit_copy_rgba8888_rgba8888(PSD psd, PDPBLITPARMS gc)
{
...
void convblit_copy_rgba8888_bgr888(PSD psd, PDPBLITPARMS gc)
{
...
void convblit_copy_rgba8888_16bpp(PSD psd, PDPBLITPARMS gc)
{
...
void convblit_copy_16bpp_16bpp(PSD psd, PDPBLITPARMS gc)
{
